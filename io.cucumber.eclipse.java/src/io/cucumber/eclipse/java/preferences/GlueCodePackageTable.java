...
//	private Button fAddFilterButton;
	...
	protected Filter[] getAllStoredFilters(boolean defaults) {
		String[] activefilters = CucumberJavaPreferences.parseList(getFilter(true, defaults));
		String[] inactivefilters = CucumberJavaPreferences.parseList(getFilter(false, defaults));
